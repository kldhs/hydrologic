...
!function (a) {
    ...
    $.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
        version: "5.1.1", htmlDecode: function (a) {
            ...
            if (!this.grid) {
                ...
                var
                    x, y = ["shiftKey", "altKey", "ctrlKey"], z = function (a, b) {
                        ...
                        if (a = a.substr(1), b += "_" + a, c = "pg_" + a, e = a + "_left", f = a + "_center", g = a + "_right", $("#" + $.jgrid.jqID(a)).append("" +
                            "<div id='" + c + "' class='ui-pager-control' role='group'>" +
                            "<table " + k(l, "pagerTable", !1, "ui-pg-table ui-common-table ui-pager-table") + ">" +
                            "<tbody>" +
                            "<tr><td id='" + e + "' align='left'></td><td id='" + f + "' align='center' style='white-space:pre;'></td><td id='" + g + "' align='right'></td></tr>" +
                            "</tbody>" +
                            "</table></div>").attr("dir", "ltr"), d.p.rowList.length > 0) {
                        ...
                        }), $("#first" + $.jgrid.jqID(b) + ", #prev" + $.jgrid.jqID(b) + ", #next" + $.jgrid.jqID(b) + ", #last" +
